...
LibraryItem* LedRgb::libraryItem() {
    return new LibraryItem( tr( "Led Rgb" ), "Leds", "ledrgb.png", "LedRgb", LedRgb::construct );
}

LedRgb::LedRgb( QString type, QString id ) : Component( type, id ), eElement( id ) {
    m_graphical = true;
    ...
    for ( int i = 0; i < 3; ++i ) {
        ...
        if ( i > 0 )
            m_led[i]->setThreshold( 3.5 );
    }
    Simulator::self()->addToUpdateList( this );

    addPropGroup(
        { tr( "Electric" ),
          { new BoolProp<LedRgb>( "CommonCathode", tr( "Common Cathode" ), "", this, &LedRgb::isComCathode,
                                  &LedRgb::setComCathode, propNoCopy ),

            new ComProperty( "", tr( "Red:" ), "", "", 0 ),

            new DoubProp<LedRgb>( "Threshold_R", tr( "Forward Voltage" ), "V", this, &LedRgb::threshold_R,
                                  &LedRgb::setThreshold_R ),

            new DoubProp<LedRgb>( "MaxCurrent_R", tr( "Max Current" ), "mA", this, &LedRgb::maxCurrent_R,
                                  &LedRgb::setMaxCurrent_R ),

            new DoubProp<LedRgb>( "Resistance_R", tr( "Resistance" ), "Ω", this, &LedRgb::res_R, &LedRgb::setRes_R ),

            new ComProperty( "", tr( "Green:" ), "", "", 0 ),

            new DoubProp<LedRgb>( "Threshold_G", tr( "Forward Voltage" ), "V", this, &LedRgb::threshold_G,
                                  &LedRgb::setThreshold_G ),

            new DoubProp<LedRgb>( "MaxCurrent_G", tr( "Max Current" ), "mA", this, &LedRgb::maxCurrent_G,
                                  &LedRgb::setMaxCurrent_G ),

            new DoubProp<LedRgb>( "Resistance_G", tr( "Resistance" ), "Ω", this, &LedRgb::res_G, &LedRgb::setRes_G ),

            new ComProperty( "", tr( "Blue:" ), "", "", 0 ),

            new DoubProp<LedRgb>( "Threshold_B", tr( "Forward Voltage" ), "V", this, &LedRgb::threshold_B,
                                  &LedRgb::setThreshold_B ),

            new DoubProp<LedRgb>( "MaxCurrent_B", tr( "Max Current" ), "mA", this, &LedRgb::maxCurrent_B,
                                  &LedRgb::setMaxCurrent_B ),
