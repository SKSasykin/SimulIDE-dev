...
LibraryItem* PCF8833::libraryItem() {
    return new LibraryItem( "Pcf8833", "Displays", "pcf8833.png", "Pcf8833", PCF8833::construct );
}

PCF8833::PCF8833( QString type, QString id ) : TftController( type, id ), Spi3Pins( id, this ) {
    m_graphical = true;
