...
St77xx::St77xx( QString type, QString id ) : TftController( type, id ), Spi5Pins( id, this ) {
    m_graphical = true;
    ...
    addPropGroup( { tr( "Main" ),
                    { new IntProp<St77xx>( "Width", tr( "Width" ), "_px", this, &St77xx::width, &St77xx::setWidth,
                                           propNoCopy, "uint" ),

                      new IntProp<St77xx>( "Height", tr( "Height" ), "_px", this, &St77xx::height, &St77xx::setHeight,
                                           propNoCopy, "uint" ),

                      new DoubProp<St77xx>( "Scale", tr( "Scale" ), "", this, &St77xx::scale, &St77xx::setScale ) },
                    0 } );
}
St77xx::~St77xx() { }
