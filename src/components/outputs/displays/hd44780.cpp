...
LibraryItem* Hd44780::libraryItem() {
    return new LibraryItem( "Hd44780", "Displays", "hd44780.png", "Hd44780", Hd44780::construct );
}

Hd44780::Hd44780( QString type, QString id ) : Hd44780_Base( type, id ), eElement( id + "-eElement" ) {
    m_pin.resize( 11 );
    ...
    for ( int i = 0; i < 8; i++ ) {
        m_dataPin[i]
            = new IoPin( 270, QPoint( 40 + i * 8, 8 ), id + "-dataPin" + QString::number( i ), 0, this, input );
