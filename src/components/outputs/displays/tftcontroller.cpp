...
TftController::TftController( QString type, QString id ) : Component( type, id ) {
    m_graphical = true;
    m_bgrInverted = false;
...
void TftController::commandReceived() {
    ...
    case 0x10:
        break; /// TODO Enter Sleep Mode
    case 0x11:
        break; /// TODO Sleep Out
    case 0x12:
        break; /// TODO Partial Mode On
    case 0x13:
        break; /// TODO Normal Mode On
    case 0x20:
        m_dispInv = false;
        break; // Display Inversion Off
    case 0x21:
        m_dispInv = true;
        break; // Display Inversion On
    case 0x26:
        m_readBytes = 1;
        break; // Gamma Set
    case 0x28:
    ...
    case 0x29:
        ...
        break; // Display On
    case 0x2A:
        m_readBytes = 2 * m_addrBytes;
        break; // Column Address Set
    case 0x2B:
        m_readBytes = 2 * m_addrBytes;
        break; // Page Address Set
    case 0x2C:
        m_readBytes = -1; // Memory Write (until next command)
        m_addrX = m_startX;
        m_addrY = m_startY;
        break;
    case 0x2D:
        m_readBytes = 128;
        break; /// FIXME // Color Set
    case 0x2E: // Memory Read
    case 0x30:
        m_readBytes = 2 * m_addrBytes;
        break; // Partial Area
    case 0x33:
        m_readBytes = 3 * m_addrBytes;
        break; // Vertical Scrolling Definition
    //case 0x34: // Tearing Effect Line Off
    case 0x35:
        m_readBytes = 1;
        break; // Tearing Effect Line On
    case 0x36:
        m_readBytes = 1;
        break; // Memory Access Control
    case 0x37:
        m_readBytes = 2;
        break; // Vertical Scrolling Start Address
    //case 0x38: // Idle Mode Off
    //case 0x39: // Idle Mode On
    case 0x3A:
        m_readBytes = 1;
        break; // COLMOD: Pixel Formay Set
    //case 0x3C: // Write Memory Continue
    //case 0x3E: // Read Memory Continue
    case 0x44:
        m_readBytes = 2;
        break; // Set Tear Scanline
    case 0x45:
        m_readBytes = 3;
        break; // Get Scanline
    case 0x51:
        m_readBytes = 1;
        break; // Write Display Brightness
    case 0x52:
        m_readBytes = 2;
        break; // Read Display Brightness
    case 0x53:
        m_readBytes = 1;
        break; // Write CTRL Display
    case 0x54:
        m_readBytes = 2;
        break; // Write CTRL Display
    case 0x55:
        m_readBytes = 1;
        break; // Write Content Adaptive Brightness Control
    case 0x56:
        m_readBytes = 2;
        break; // Read Content Adaptive Brightness Control
    case 0x5E:
        m_readBytes = 1;
        break; // Write CABC Minimum Brightness
    case 0x5F:
        m_readBytes = 2;
        break; // Read CABC Minimum Brightness

    case 0xB0:
        m_readBytes = 1;
        break; // RGB Interface Signal Control
    case 0xB1:
        m_readBytes = 2;
        break; // Frame Rate Control (In Normal Mode/Full Colors:
    case 0xB2:
        m_readBytes = 2;
        break; // Frame Rate Control (In Idle Mode/8 colors:
    case 0xB3:
        m_readBytes = 2;
        break; // Frame Rate control (In Partial Mode/Full Colors:
    case 0xB4:
        m_readBytes = 1;
        break; // Display Inversion Control
    case 0xB5:
        m_readBytes = 4;
        break; // Blanking Porch Control
    case 0xB6:
        m_readBytes = 4;
        break; // Display Function Control
    case 0xB7:
        m_readBytes = 1;
        break; // Entry Mode Set
    case 0xB8:
        m_readBytes = 1;
        break; // Backlight Control 1
    case 0xB9:
        m_readBytes = 1;
        break; // Backlight Control 2
    case 0xBA:
        m_readBytes = 1;
        break; // Backlight Control 3
    case 0xBB:
        m_readBytes = 1;
        break; // Backlight Control 4
    case 0xBC:
        m_readBytes = 1;
        break; // Backlight Control 5
    case 0xBE:
        m_readBytes = 1;
        break; // Backlight Control 7
    case 0xBF:
        m_readBytes = 1;
        break; // Backlight Control 8
    case 0xC0:
        m_readBytes = 1;
        break; // Power Control 1
    case 0xC1:
        m_readBytes = 1;
        break; // Power Control 2
    case 0xC5:
        m_readBytes = 2;
        break; // VCOM Control 1
    case 0xC7:
        m_readBytes = 1;
        break; // VCOM Control 2
    case 0xCB:
        m_readBytes = 5;
        break; /// Power control A: 0x39, 0x2C, 0x00, 0x34, 0x02,
    case 0xCF:
        m_readBytes = 3;
        break; /// Power control B: 0x00, 0xC1, 0x30,
    case 0xD0:
        m_readBytes = 2;
        break; // NV Memory Write
    case 0xD1:
        m_readBytes = 3;
        break; // NV Memory Protection Key
    case 0xD2:
        m_readBytes = 3;
        break; // NV Memory Status Read
    case 0xD3:
        m_readBytes = 4;
        break; // Read ID4
    case 0xDA:
    ...
    case 0xE0:
        m_readBytes = 15;
        break; // Positive Gamma Correction
    case 0xE1:
        m_readBytes = 15;
        break; // Negative Gamma Correction
    case 0xE2:
        m_readBytes = 16;
        break; // Digital Gamma Control 1
    case 0xE3:
        m_readBytes = 64;
        break; // Digital Gamma Control 2
    case 0xE8:
        m_readBytes = 3;
        break; /// Driver timing control A: 0x85, 0x00, 0x78,
    case 0xE9:
        m_readBytes = 3;
        break; // Equalize time control
    case 0xEA:
        m_readBytes = 2;
        break; /// Driver timing control B: 0x00, 0x00,
    case 0xEC:
        m_readBytes = 1;
        break; // Program Mode Control
    case 0xED:
        m_readBytes = 4;
        break; /// Power on sequence control: 0x64, 0x03, 0x12, 0x81,
    case 0xEF:
        m_readBytes = 3;
        break; /// 0x03, 0x80, 0x02, // Misterious Commands in Adafruit_ILI9341.cpp initcmd[]
    case 0xF2:
        m_readBytes = 1;
        break; /// Enable 3G: 0x00, 0x00,
    case 0xF6:
        m_readBytes = 3;
        break; // Interface Control
    case 0xF7:
        m_readBytes = 1;
        break; /// Pump ratio control 0x20,
    case 0xFA:
        m_readBytes = 4;
        break; // Program Mode Enable
    case 0xFC:
        m_readBytes = 2;
        break; // NVM Setting
    case 0xFE:
        m_readBytes = 2;
        break; // Program action
    default:
        qDebug() << "TftController::proccessCommand: Not implemented" << m_lastCommand;
    }
}
    ...
    case 0x2A: // Column Address Set
    {
        if ( m_addrBytes == 1 ) {
            ...
            if ( m_readBytes == 4 )
                ...
                setStartX( m_data | buffer );
            else if ( m_readBytes == 2 )
                m_data = buffer << 8;
            else if ( m_readBytes == 1 )
                setEndX( m_data | buffer );
        }
    } break;
    case 0x2B: // Page Address Set
    {
        if ( m_addrBytes == 1 ) {
            ...
            if ( m_readBytes == 4 )
                ...
                setStartY( m_data | buffer );
            else if ( m_readBytes == 2 )
                m_data = buffer << 8;
            else if ( m_readBytes == 1 )
                setEndY( m_data | buffer );
        }
    } break;
    case 0x2C:
        writeRam();
        break; // RAMWR: Memory Write. Overriden by displays
    case 0x33: // Vertical Scrolling Definition
    {
        if ( m_readBytes == 6 )
            m_TFA = buffer << 8; // TFA [15:8]
        else if ( m_readBytes == 5 )
            m_TFA |= buffer; // TFA [7:0]
        else if ( m_readBytes == 4 )
            m_VSA = buffer << 8; // VSA [15:8]
        else if ( m_readBytes == 3 )
            m_VSA |= buffer; // VSA [7:0]
        else if ( m_readBytes == 2 )
            m_BFA = buffer << 8; // BFA [15:8]
        else if ( m_readBytes == 1 )
            m_BFA |= buffer; // BFA [7:0]
    } break;
    case 0x37: // Vertical Scrolling Start Address, Ignored if Partial Mode
    {
        if ( m_readBytes == 2 )
            m_VSP = buffer << 8; // VSP [15:8]
        else
            m_VSP |= buffer; // VSP [7:0]
    } break;
    case 0x3A:
        setPixelMode();
        break; // COLMOD: Pixel Format Set
...
void TftController::setRamSize( int x, int y ) {
    ...
    if ( m_maxX == 0 )
        m_DDRAM.resize( x, std::vector<uint32_t>( y, 0 ) ); // Resize only first time
...
void TftController::paint( QPainter* p, const QStyleOptionGraphicsItem*, QWidget* ) {
    ...
    if ( !m_dispOn )
        p->fillRect( imgRect, Qt::black ); // Display Off
    else {
        printImage();
