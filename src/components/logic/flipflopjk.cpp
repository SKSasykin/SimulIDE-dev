...
LibraryItem* FlipFlopJK::libraryItem() {
    return new LibraryItem( tr( "FlipFlop JK" ), "Memory", "3to2.png", "FlipFlopJK", FlipFlopJK::construct );
}

FlipFlopJK::FlipFlopJK( QString type, QString id ) : FlipFlopBase( type, id ) {
    m_width = 3;
    m_height = 4;
    m_dataPins = 2;
