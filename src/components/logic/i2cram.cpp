...
LibraryItem* I2CRam::libraryItem() {
    return new LibraryItem( tr( "I2C Ram" ), "Memory", "2to3.png", "I2CRam", I2CRam::construct );
}

I2CRam::I2CRam( QString type, QString id ) : IoComponent( type, id ), TwiModule( id ), MemData() {
    m_width = 4;
    m_height = 4;

    init( { // Inputs:
            "IL01SDA", //type: Input, side: Left, pos: 01, label: "SDA"
            "IL03SCL", "IR01A0", "IR02A1", "IR03A2" } );
    ...
    addPropGroup( { tr( "Main" ),
                    {
                        new IntProp<I2CRam>( "Size_bytes", tr( "Size" ), "_bytes", this, &I2CRam::rSize,
                                             &I2CRam::setRSize, propNoCopy, "uint" ),

                        new IntProp<I2CRam>( "Control_Code", tr( "I2C Address" ), "", this, &I2CRam::cCode,
                                             &I2CRam::setCcode, 0, "uint" ),

                        new DoubProp<I2CRam>( "Frequency", tr( "I2C Frequency" ), "_kHz", this, &I2CRam::freqKHz,
                                              &I2CRam::setFreqKHz ),

                        new BoolProp<I2CRam>( "Persistent", tr( "Persistent" ), "", this, &I2CRam::persistent,
                                              &I2CRam::setPersistent ),
                    },
                    groupNoCopy } );

    addPropGroup(
        { "Hidden", { new StrProp<I2CRam>( "Mem", "", "", this, &I2CRam::getMem, &I2CRam::setMem ) }, groupHidden } );
}
I2CRam::~I2CRam() { }
...
void I2CRam::slotShowTable() {
    ...
    if ( m_persistent )
        m_memTable->setWindowTitle( "I2C ROM: " + m_idLabel->toPlainText() );
    else
        m_memTable->setWindowTitle( "I2C RAM: " + m_idLabel->toPlainText() );
    m_memTable->setData( &m_ram );
}
