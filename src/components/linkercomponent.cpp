...
LinkerComponent::LinkerComponent( QString type, QString id ) : Component( type, id ) {
    m_isLinker = true;
    ...
    addPropGroup( { "Hidden",
                    { new StrProp<LinkerComponent>( "Links", "Links", "", this, &LinkerComponent::getLinks,
                                                    &LinkerComponent::setLinks ) },
                    groupHidden } );
}
