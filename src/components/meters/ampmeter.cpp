...
LibraryItem* Amperimeter::libraryItem() {
    return new LibraryItem( tr( "Ampmeter" ), "Meters", "amperimeter.png", "Amperimeter", Amperimeter::construct );
}

Amperimeter::Amperimeter( QString type, QString id ) : Meter( type, id ) {
    m_unit = "A";
    m_dispValue = 0;
    setResistance( 1e-6 );
