...
void LogicFamily::setFamily( QString f ) {
    ...
    if ( f == "Custom" )
        ...
        setFamilyData( m_families.value( f ) );
}
...
void LogicFamily::getFamilies() // Static
{
    ...
    for ( QString line : docLines ) {
        ...
        for ( const propStr_t& property : properties ) {
            ...
            if ( propName == u"supply" )
                family.supply = propValue;
            else if ( propName == u"inpLHp" )
                family.inpLHp = propValue;
            else if ( propName == u"inpHLp" )
                family.inpHLp = propValue;
            else if ( propName == u"inpImp" )
                family.inpImp = propValue;
            else if ( propName == u"inpPul" )
                family.inpPul = propValue;
            else if ( propName == u"outHip" )
                family.outHip = propValue;
            else if ( propName == u"outLop" )
                family.outLop = propValue;
            else if ( propName == u"outImp" )
                family.outImp = propValue;
            else if ( propName == u"outPul" )
                family.outPul = propValue;
        }
