...
CapacitorBase::CapacitorBase( QString type, QString id ) : Reactive( type, id ) {
    ...
    addPropGroup( { tr( "Main" ),
                    {
                        new DoubProp<CapacitorBase>( "Capacitance", tr( "Capacitance" ), "µF", this,
                                                     &CapacitorBase::value, &CapacitorBase::setValue ),

                        new DoubProp<CapacitorBase>( "Resistance", tr( "Resistance" ), "µΩ", this,
                                                     &CapacitorBase::resist, &CapacitorBase::setResist ),

                        new DoubProp<CapacitorBase>( "InitVolt", tr( "Initial Voltage" ), "V", this,
                                                     &CapacitorBase::initVolt, &CapacitorBase::setInitVolt ),
