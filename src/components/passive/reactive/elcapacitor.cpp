...
LibraryItem* elCapacitor::libraryItem() {
    return new LibraryItem( tr( "Electrolytic Capacitor" ), "Reactive", "elcapacitor.png", "elCapacitor",
                            elCapacitor::construct );
}

elCapacitor::elCapacitor( QString type, QString id ) : CapacitorBase( type, id ) {
