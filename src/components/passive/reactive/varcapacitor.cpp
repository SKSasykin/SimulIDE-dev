...
LibraryItem* VarCapacitor::libraryItem() {
    return new LibraryItem( tr( "Variable Capacitor" ), "Reactive", "varcapacitor.png", "VarCapacitor",
                            VarCapacitor::construct );
}

VarCapacitor::VarCapacitor( QString type, QString id ) : Dialed( type, id ), eReactive( id ) {
    ...
    addPropGroup( { tr( "Main" ),
                    {
                        new DoubProp<VarCapacitor>( "Min_Capacitance", tr( "Minimum Capacitance" ), "µF", this,
                                                    &VarCapacitor::minVal, &VarCapacitor::setMinVal ),

                        new DoubProp<VarCapacitor>( "Max_Capacitance", tr( "Maximum Capacitance" ), "µF", this,
                                                    &VarCapacitor::maxVal, &VarCapacitor::setMaxVal ),

                        new DoubProp<VarCapacitor>( "Capacitance", tr( "Current Value" ), "µF", this,
                                                    &VarCapacitor::getVal, &VarCapacitor::setVal ),

                        new DoubProp<VarCapacitor>( "Resistance", tr( "Resistance" ), "µΩ", this, &VarCapacitor::resist,
                                                    &VarCapacitor::setResist ),

                        new DoubProp<VarCapacitor>( "InitVolt", tr( "Initial Voltage" ), "V", this,
                                                    &VarCapacitor::initVolt, &VarCapacitor::setInitVolt ),

                        new DoubProp<VarCapacitor>( "Dial_Step", tr( "Dial Step" ), "µF", this, &VarCapacitor::getStep,
                                                    &VarCapacitor::setStep ),
                    },
                    0 } );
