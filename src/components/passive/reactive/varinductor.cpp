...
LibraryItem* VarInductor::libraryItem() {
    return new LibraryItem( tr( "Variable Inductor" ), "Reactive", "varinductor.png", "VarInductor",
                            VarInductor::construct );
}

VarInductor::VarInductor( QString type, QString id ) : Dialed( type, id ), eReactive( id ) {
    ...
    addPropGroup( { tr( "Main" ),
                    {
                        new DoubProp<VarInductor>( "Min_Inductance", tr( "Minimum Inductance" ), "mH", this,
                                                   &VarInductor::minVal, &VarInductor::setMinVal ),

                        new DoubProp<VarInductor>( "Max_Inductance", tr( "Maximum Inductance" ), "mH", this,
                                                   &VarInductor::maxVal, &VarInductor::setMaxVal ),

                        new DoubProp<VarInductor>( "Inductance", tr( "Current Value" ), "mH", this,
                                                   &VarInductor::getVal, &VarInductor::setVal ),

                        new DoubProp<VarInductor>( "Resistance", tr( "Resistance" ), "µΩ", this, &VarInductor::resist,
                                                   &VarInductor::setResist ),

                        new DoubProp<VarInductor>( "InitVolt", tr( "Initial Voltage" ), "V", this,
                                                   &VarInductor::initVolt, &VarInductor::setInitVolt ),

                        new DoubProp<VarInductor>( "Dial_Step", tr( "Dial Step" ), "mH", this, &VarInductor::getStep,
                                                   &VarInductor::setStep ),
                    },
                    0 } );
