...
LibraryItem* Jfet::libraryItem() {
    return new LibraryItem( tr( "Jfet" ), "Transistors", "jfet.png", "Jfet", Jfet::construct );
}

Jfet::Jfet( QString type, QString id ) : Component( type, id ), eJfet( id ) {
    ...
    addPropGroup(
        { tr( "Electric" ),
          { new DoubProp<Jfet>( "Idss", tr( "Idss" ), "A", this, &Jfet::Idss, &Jfet::setIdss ),

            new DoubProp<Jfet>( "Vp", tr( "Vp" ), "V", this, &Jfet::Vp, &Jfet::setVp ),

            new DoubProp<Jfet>( "1/Lambda", tr( "1/Lambda" ), "V", this, &Jfet::LambdaInv, &Jfet::setLambdaInv ) },
          0 } );
}
Jfet::~Jfet() { }
