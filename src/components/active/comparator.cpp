...
LibraryItem* Comparator::libraryItem() {
    return new LibraryItem( tr( "Comparator" ), "Other Active", "opamp.png", "Comparator", Comparator::construct );
}

Comparator::Comparator( QString type, QString id ) : IoComponent( type, id ), eElement( id ) {
    m_width = 4;
    setNumInps( 2, "", 0 );
    setNumOuts( 1, "", -1 );
