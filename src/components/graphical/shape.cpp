...
Shape::Shape( QString type, QString id ) : Component( type, id ) {
    m_graphical = true;
    ...
    addPropGroup(
        { tr( "Main" ),
          { new IntProp<Shape>( "H_size", tr( "Width" ), "_px", this, &Shape::hSize, &Shape::setHSize, 0, "uint" ),

            new IntProp<Shape>( "V_size", tr( "Height" ), "_px", this, &Shape::vSize, &Shape::setVSize, 0, "uint" ),

            new DoubProp<Component>( "Angle", tr( "Angle" ), "_º", this, &Component::getAngle, &Component::setAngle ),
    ...
    addPropGroup(
        { tr( "Color" ),
          { new StrProp<Shape>( "Color", tr( "Color" ), "", this, &Shape::colorStr, &Shape::setColorStr, 0, "color" ),
