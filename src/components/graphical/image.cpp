...
LibraryItem* Image::libraryItem() {
    return new LibraryItem( tr( "Image" ), "Graphical", "img.png", "Image", Image::construct );
}

Image::Image( QString type, QString id ) : Shape( type, id ) {
    m_background = "";
    ...
    addProperty( tr( "Main" ),
                 new BoolProp<Image>( "Embeed_bck", tr( "Embeed background" ), "", this, &Image::embeedBck,
                                      &Image::setEmbeedBck ) );
    ...
    addPropGroup(
        { "Hidden",
          { new StrProp<Image>( "Image_File", tr( "Image File" ), "", this, &Image::background, &Image::setBackground ),
            ...
            new StrProp<Image>( "BckGndData", "", "", this, &Image::bckGndData, &Image::setBckGndData ) },
...
void Image::slotLoad() {
    ...
    QString fileName = QFileDialog::getOpenFileName( 0l, tr( "Load Image" ), dir, tr( "All files (*.*)" ) );
...
void Image::setBackground( QString bck ) {
    ...
    if ( bck.endsWith( ".gif" ) ) {
        ...
        if ( m_movie->isValid() ) {
            ...
            qDebug() << "Image::setBackground : not a valid Gif animation";
    }
