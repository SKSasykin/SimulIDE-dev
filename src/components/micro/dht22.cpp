...
LibraryItem* Dht22::libraryItem() {
    return new LibraryItem( "DHt22/11", "Sensors", "dht22_ico.png", "Dht22", Dht22::construct );
}

Dht22::Dht22( QString type, QString id ) : Component( type, id ), eElement( id ) {
    ...
    addPropGroup(
        { tr( "Main" ),
          {
              new StrProp<Dht22>( "DHT22", tr( "Model" ), "DHT11,DHT22", this, &Dht22::model, &Dht22::setModel,
                                  propNoCopy, "enum" ),

              new DoubProp<Dht22>( "Temp", tr( "Tempature" ), "°C", this, &Dht22::temperature, &Dht22::setTemperature ),

              new DoubProp<Dht22>( "TempInc", tr( "Temp. increment" ), "°C", this, &Dht22::tempInc,
                                   &Dht22::setTempInc ),

              new DoubProp<Dht22>( "Humi", tr( "Humidity" ), "_%", this, &Dht22::humidity, &Dht22::setHumidity ),

              new DoubProp<Dht22>( "HumiInc", tr( "Humid. increment" ), "_%", this, &Dht22::humidInc,
                                   &Dht22::setHumidInc ),
          },
          0 } );
}
...
void Dht22::voltChanged() // Called when Input Pin changes
{
    ...
    if ( m_lastIn && !inState )
        m_lastTime = Simulator::self()->circTime(); // Falling edge
...
QString Dht22::model() {
    return m_DHT22 ? "DHT22" : "DHT11";
}

double Dht22::trim( double data ) {
    return (double) ( ( (int) ( data * 10 ) ) ) / 10;
}
