...
LibraryItem* VoltSource::libraryItem() {
    return new LibraryItem( tr( "Voltage Source" ), "Sources", "voltsource.png", "Voltage Source",
                            VoltSource::construct );
}

VoltSource::VoltSource( QString type, QString id ) : VarSource( type, id ) {
    m_pin.resize( 1 );
    ...
    addPropGroup( { tr( "Main" ),
                    { new DoubProp<VoltSource>( "Value_Volt", tr( "Current Value" ), "V", this, &VoltSource::getVal,
                                                &VoltSource::setVal ),

                      new DoubProp<VoltSource>( "MaxValue", tr( "Max. Voltage" ), "V", this, &VoltSource::maxValue,
                                                &VoltSource::setMaxValue ),

                      new DoubProp<VoltSource>( "MinValue", tr( "Min. Voltage" ), "V", this, &VoltSource::minValue,
                                                &VoltSource::setMinValue ) },
                    0 } );
