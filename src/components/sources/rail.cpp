...
LibraryItem* Rail::libraryItem() {
    return new LibraryItem( tr( "Rail" ), "Sources", "rail.png", "Rail", Rail::construct );
}

Rail::Rail( QString type, QString id ) : Component( type, id ), eElement( id ) {
    setLabelPos( -64, -24 );
...
void Rail::paint( QPainter* p, const QStyleOptionGraphicsItem* o, QWidget* w ) {
    ...
    static const QPointF points[4] = { QPointF( -1.5, -6.5 ), QPointF( -1.5, 6.5 ), QPointF( 9, 1 ), QPointF( 9, -1 ) };
