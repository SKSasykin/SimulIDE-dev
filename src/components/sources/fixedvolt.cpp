...
LibraryItem* FixedVolt::libraryItem() {
    return new LibraryItem( tr( "Fixed Voltage" ), "Sources", "voltage.png", "Fixed Voltage", FixedVolt::construct );
}

FixedVolt::FixedVolt( QString type, QString id ) : Component( type, id ), eElement( id ) {
    m_graphical = true;
    m_changed = false;
