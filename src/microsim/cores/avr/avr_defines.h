...
enum {
    ...
    S_H,
    S_T,
    S_I, // SREG bit indexes
    R_XL = 0x1a,
    R_XH,
    R_YL,
    R_YH,
    R_ZL,
    R_ZH, // 16 bits register pairs
...
#define get_vd5( o ) get_d5( o ) const uint8_t vd = m_dataMem[d];
...
#define get_vh4_k8( o ) get_h4_k8( o ) const uint8_t vh = m_dataMem[h];

#define get_d5_q6( o ) get_d5( o ) const uint8_t q = ( ( o & 0x2000 ) >> 8 ) | ( ( o & 0x0c00 ) >> 7 ) | ( o & 0x7 );
