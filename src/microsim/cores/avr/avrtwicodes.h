...
enum twiState_t {
    ...
    = 0x68, // 104 Arbitration lost in SLA+R/W as Master; own SLA+W has been received; ACK has been returned
    TWI_SRX_GEN_ACK = 0x70, //* 112 General call address has been received; ACK has been returned
    TWI_SRX_GEN_ACK_M_ARB_LOST
    = 0x78, // 120 Arbitration lost in SLA+R/W as Master; General call address has been received; ACK has been returned
    TWI_SRX_ADR_DATA_ACK
    = 0x80, //* 128 Previously addressed with own SLA+W; data has been received; ACK has been returned
    TWI_SRX_ADR_DATA_NACK
    = 0x88, //* 136 Previously addressed with own SLA+W; data has been received; NOT ACK has been returned
    TWI_SRX_GEN_DATA_ACK
    = 0x90, //* 144 Previously addressed with general call; data has been received; ACK has been returned
    TWI_SRX_GEN_DATA_NACK
    = 0x98, //* 152 Previously addressed with general call; data has been received; NOT ACK has been returned
    TWI_SRX_STOP_RESTART
    = 0xA0, // 160 A STOP condition or repeated START condition has been received while still addressed as Slave

    // TWI Slave Transmitter status codes
    TWI_STX_ADR_ACK = 0xA8, //* 168 Own SLA+R has been received; ACK has been returned
    TWI_STX_ADR_ACK_M_ARB_LOST
    = 0xB0, // 176 Arbitration lost in SLA+R/W as Master; own SLA+R has been received; ACK has been returned
    ...
    = 0xC8, // 200 Last data byte in TWDR has been transmitted (TWEA = �0�); ACK has been received
