...
AvrAdc* AvrAdc::createAdc( eMcu* mcu, QString name, int type ) {
    switch ( type ) {
    case 00:
        return new AvrAdc00( mcu, name );
        break;
    case 02:
        return new AvrAdc02( mcu, name );
        break;
    case 03:
        return new AvrAdc03( mcu, name );
        break;
    case 04:
        return new AvrAdc04( mcu, name );
        break;
    case 10:
        return new AvrAdc10( mcu, name );
        break;
    case 11:
        return new AvrAdc11( mcu, name );
        break;
    case 20:
        return new AvrAdc20( mcu, name );
        break;
    default:
        return nullptr;
    }
...
AvrAdc::AvrAdc( eMcu* mcu, QString name ) : McuAdc( mcu, name ) { }
AvrAdc::~AvrAdc() { }
...
void AvrAdc::setup() {
    ...
    if ( m_mcu->getMcuPort( "PORTV" ) ) {
        ...
        if ( m_aRefPin )
            m_aRefPin->setInputImp( 32000 ); // Internal 32K resistor on the AREF pin
    }
...
void AvrAdc::configureA( uint8_t newADCSRA ) // ADCSRA
{
    ...
    if ( m_enabled != enabled ) {
        if ( !m_enabled && enabled )
            m_initCycles = 12; // First conversion after enabling ADC
        m_enabled = enabled;
        toAdcMux();
    }
...
void AvrAdc::toAdcMux() // Connect Comparator with ADC multiplexer
{
    ...
    if ( connect )
        m_aComp->setPinN( m_adcPin[m_channel] );
    else
        m_aComp->setPinN( nullptr );
}
...
void AvrAdc::endConversion() {
    ...
    if ( m_autoTrigger && m_freeRunning )
        startConversion();
}
...
AvrAdc00::AvrAdc00( eMcu* mcu, QString name ) : AvrAdc( mcu, name ) { }
AvrAdc00::~AvrAdc00() { }
...
AvrAdc02::AvrAdc02( eMcu* mcu, QString name ) : AvrAdc00( mcu, name ) { }
AvrAdc02::~AvrAdc02() { }
...
void AvrAdc02::updtVref() {
    ...
    switch ( m_refSelect ) {
    case 1:
        m_vRefP = m_pRefPin->getVoltage();
        break; // External voltage reference at PA0 (AREF)
    case 2:
        m_vRefP = 1.1;
        break; // Internal Vref. 1.1 Volt
    }
}
...
AvrAdc03::AvrAdc03( eMcu* mcu, QString name ) : AvrAdc00( mcu, name ) { }
AvrAdc03::~AvrAdc03() { }
...
void AvrAdc03::specialConv() {
    ...
    if ( m_channel == 30 )
        ...
        if ( m_adcValue > m_maxValue )
            m_adcValue = m_maxValue;
    }
...
AvrAdc04::AvrAdc04( eMcu* mcu, QString name ) : AvrAdc03( mcu, name ) { }
AvrAdc04::~AvrAdc04() { }
...
AvrAdc10::AvrAdc10( eMcu* mcu, QString name ) : AvrAdc( mcu, name ) { }
AvrAdc10::~AvrAdc10() { }
...
void AvrAdc10::updtVref() {
    if ( m_refSelect == 1 )
        m_vRefP = 1.1; ///TODO // Internal Vref. = ??? 1.1 Volt
    else
        m_vRefP = m_mcu->vdd();
}
...
AvrAdc11::AvrAdc11( eMcu* mcu, QString name ) : AvrAdc10( mcu, name ) { }
AvrAdc11::~AvrAdc11() { }
...
void AvrAdc11::updtVref() {
    ...
    case 1:
        m_vRefP = m_pRefPin->getVoltage();
        break; // External voltage reference at PB0 (AREF)
    case 2:
        m_vRefP = 1.1;
        break; // Internal Vref. 1.1 Volt
    case 3:
    ...
    case 7:
        m_vRefP = 2.56;
        break; // Internal 2.56V Voltage Reference with external capacitor
    }
}
...
AvrAdc20::AvrAdc20( eMcu* mcu, QString name ) : AvrAdc( mcu, name ) { }
AvrAdc20::~AvrAdc20() { }
