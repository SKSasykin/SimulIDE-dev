...
PicComp* PicComp::createComparator( eMcu* mcu, QString name, int type ) // Static
{
    switch ( type ) {
    case 01:
        return new PicComp01( mcu, name );
    case 02:
        return new PicComp02( mcu, name );
    case 03:
        return new PicComp03( mcu, name );
    case 11:
        return new PicComp11( mcu, name );
    case 12:
        return new PicComp12( mcu, name );
    default:
        return nullptr;
    }
}

PicComp::PicComp( eMcu* mcu, QString name ) : McuComp( mcu, name ) { }
PicComp::~PicComp() { }

void PicComp::setup() {
    McuVref* vref = m_mcu->vrefModule();
    if ( vref )
        vref->addCallBack( this, true ); // Vref Module will update vref if changed.
}
...
void PicComp::voltChanged() {
    ...
    if ( m_compOut != compOut ) {
        ...
        m_interrupt->raise();
        if ( m_pinOut )
            m_pinOut->setOutState( m_compOut );
...
PicComp0::PicComp0( eMcu* mcu, QString name ) : PicComp( mcu, name ) { }
PicComp0::~PicComp0() { }
...
PicComp01::PicComp01( eMcu* mcu, QString name ) : PicComp0( mcu, name ) { }
PicComp01::~PicComp01() { }
...
void PicComp01::setMode( uint8_t mode ) {
    ...
    case 0:
        m_enabled = false;
        connect( m_pins[0], m_pins[1], nullptr );
        break;
    case 1:
        connect( pinN, m_pins[2], nullptr );
        break;
    case 2:
        m_fixVref = true;
        connect( pinN, nullptr, nullptr );
        break;
    case 3:
        connect( m_pins[0], m_pins[2], nullptr );
        break;
    case 4:
        connect( m_pins[0], m_pins[1], nullptr );
        break;
    case 5:
        ...
        break;
    case 6:
        connect( m_pins[0], m_pins[2], m_pins[1] );
        break;
    case 7:
        m_enabled = false;
        connect( nullptr, nullptr, nullptr );
...
PicComp02::PicComp02( eMcu* mcu, QString name ) : PicComp0( mcu, name ) { }
PicComp02::~PicComp02() { }
...
void PicComp02::setMode( uint8_t mode ) {
    ...
    case 4: // Fallthrough
    case 5:
        connect( m_pins[0], m_pins[1], m_pins[2] );
        break;
    case 6:
        connect( m_pins[0], m_pins[1], nullptr );
        break;
...
PicComp03::PicComp03( eMcu* mcu, QString name ) : PicComp0( mcu, name ) { }
PicComp03::~PicComp03() { }
...
void PicComp03::setMode( uint8_t mode ) {
    ...
    case 3:
        m_fixVref = true;
        connect( m_pins[0], nullptr, m_pins[2] );
        break;
    case 4:
        m_fixVref = true;
        connect( m_pins[0], nullptr, nullptr );
        break;
    case 5:
        pinO = m_pins[2]; // Fallthrough
    case 6:
        m_fixVref = true;
        connect( pinN, nullptr, pinO );
        break;
    case 7:
        m_enabled = false;
        connect( nullptr, nullptr, nullptr );
...
PicComp1::PicComp1( eMcu* mcu, QString name ) : PicComp( mcu, name ) { }
PicComp1::~PicComp1() { }
...
PicComp11::PicComp11( eMcu* mcu, QString name ) : PicComp1( mcu, name ) { }
PicComp11::~PicComp11() { }
...
PicComp12::PicComp12( eMcu* mcu, QString name ) : PicComp1( mcu, name ) { }
PicComp12::~PicComp12() { }
...
PicComp20::PicComp20( eMcu* mcu, QString name ) : PicComp( mcu, name ) { }
PicComp20::~PicComp20() { }
