...
QString ComProperty::name() {
    return m_name;
}
QString ComProperty::capt() {
    return m_capt;
}
QString ComProperty::type() {
    return m_type;
}
QString ComProperty::unit() {
    return m_unit;
}
uint8_t ComProperty::flags() {
    return m_flags;
}
...
double ComProperty::getValue() {
    return getValStr().toDouble();
}

QString ComProperty::toString() {
    return getValStr();
}
