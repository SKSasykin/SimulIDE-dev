...
private:
    ...
    inline void addToChangedNodes( eNode* nod ) {
        nod->nextCH = m_changedNode;
        m_changedNode = nod;
    }
    inline void addToChangedList( eElement* el ) {
        el->nextChanged = m_voltChanged;
        m_voltChanged = el;
    }
    inline void addToNoLinList( eElement* el ) {
        el->nextChanged = m_nonLinear;
        m_nonLinear = el;
    }
